...
class Loader
{
    ...
    {
        $this->actions = $this->_add($this->actions, $hook, $component, $callback, $priority, $accepted_args);
    }
    ...
    {
        $this->shortcodes = $this->_add($this->shortcodes, $hook, $component, $callback);
    }
     ...
     */
    private function _add($hooks, $hook, $component, $callback, $priority = null, $accepted_args = null)
    {
